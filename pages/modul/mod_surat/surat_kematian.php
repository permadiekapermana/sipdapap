...
mysql_query("UPDATE penduduk SET id_statuspenduduk = 'STP.003'
...
if (!empty($query))
	...
	$pdf->Cell(3,1,'Yang bertanda tangan di bawah ini Kepala Desa Sitiwinangun Kecamatan Jamblang Kabupaten',0,0,'L');
		...
		$pdf->Ln();
		$pdf->Cell(3,1,'Telah Meninggal Dunia pada :',0,0,'L');
		$pdf->Ln();
	...
	$pdf->Cell(2,1,'',2,0,'L');
		...
		$pdf->Cell(3,1,'Demikian surat keterangan kemarian ini kami buat agar menjadi tahu dan maklum adanya dan dapat',0,0,'L');
		$pdf->Ln();		
