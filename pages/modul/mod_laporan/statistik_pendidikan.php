...
while ($pendidikan=mysql_fetch_array($baca))
{
	...
	$pdf->Cell(1,1,$no,1,0,'C');
	$pdf->Cell(6,1, $pendidikan[pendidikan] ,1,0,'C');
	$pdf->Cell(4,1,$j_pendidikan_l,1,0,'C');
	$pdf->Cell(3,1,$pros_pendidikan_l.'%',1,0,'C');
	$pdf->Cell(4,1,$j_pendidikan_p,1,0,'C');
	$pdf->Cell(3,1,$pros_pendidikan_p.'%',1,0,'C');
	$pdf->Cell(4,1,$j_tot_pendidikan,1,0,'C');
	$pdf->Cell(4,1,$j_pros_pendidikan.'%',1,0,'C');
